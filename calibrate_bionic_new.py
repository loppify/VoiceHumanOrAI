...
print(f"AI Mean Score: {np.mean(ai_rs):.2f}, Std: {np.std(ai_rs):.2f}, Min: {np.min(ai_rs):.2f}, Max: {np.max(ai_rs):.2f}")
print(f"Human Mean Score: {np.mean(human_rs):.2f}, Std: {np.std(human_rs):.2f}, Min: {np.min(human_rs):.2f}, Max: {np.max(human_rs):.2f}")
